    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 5: Escribir una frase dinámicamente\n\nSe escribirán 16 letras en la primera fila de la pantalla (Coordenada Y=0) a una velocidad de letra por segundo.\n\nLa coordenada X vendr dada por el contador de módulo 16, es decir contará de 0 a 15 (las 16 posiciones de la fila)-\n\nUsaremos el contador para indexar en la tabla de memoria donde  tenemos las letras introducidas de forma que en la \ncoordenada 0 se pintará la letra de la posición 0 de la memoria, en la coordenada X=1 se pintará la letra que está en la memoria en la posición 1\ny así sucesivamente\nLa memoria inicial se sobreescribe para inicicializar la LCD con la pantalla en blanco.",
            "readonly": true
          },
          "position": {
            "x": 96,
        ...
        {
          "id": "af8428af-fe52-4de5-bc0e-fa4cd18f941a",
        ...
        {
          "id": "d5f0e3fd-95de-49ae-bb8d-8eb81bbf5ca5",
        ...
        {
          "id": "76a90ff9-681f-4378-b0b9-8d8b165e5332",
        ...
        {
          "id": "4a25f9cc-9eab-45dc-8133-cc4b9a04963d",
          "type": "basic.info",
          "data": {
            "info": "**Coordenada X** donde se pintará la letra, el contador irá de 0 a 15",
            "readonly": true
          },
          "position": {
            "x": 344,
        ...
        {
          "id": "55bf072e-5201-4bde-bd65-2c551d5f9bba",
          "type": "basic.info",
          "data": {
            "info": "**Temporizador de escritura**, cada segundo escribirá en pantalla una letra",
            "readonly": true
          },
          "position": {
            "x": 112,
        ...
        {
          "id": "faf83c16-30a1-49e9-8fa7-7ab658ffe8a4",
          "type": "basic.info",
          "data": {
            "info": "**Las letras**, cada posición de memoria contiene el código ASCII de una letra",
            "readonly": true
          },
          "position": {
            "x": 640,
        ...
        {
          "id": "97f4d886-75d7-4289-a15d-105d47f96ec4",
          "type": "basic.info",
          "data": {
            "info": "**Coordenada Y**, para el ejemplo escribiremos en la primera fila (Y=0) si quieres puedes cambiar a Y=1 y verás como se escribe en la segunda línea",
            "readonly": true
          },
          "position": {
            "x": 1304,
        ...
        {
          "id": "b3f223c6-841f-408e-bc10-5f552a55adef",
          "type": "basic.info",
          "data": {
            "info": "Como el bloque de tabla es asíncrono, necesitamos **sincronizar** la coordenada con el dato mediante dos registros, uno para cada variable",
            "readonly": true
          },
          "position": {
            "x": 1096,
        ...
        {
          "id": "db1c2716-7deb-4e2c-9cff-58c5d18cee25",
          "type": "basic.info",
          "data": {
            "info": "Como el bloque de tabla es asíncrono, necesitamos **sincronizar** la coordenada con el dato mediante dos registros, uno para cada variable",
            "readonly": true
        ...
        {
          "id": "baa39097-f878-4b00-b6f0-1f200971c6d4",
          "type": "basic.info",
          "data": {
            "info": "La LCD no entiende de coordenadas, sino de direcciones de memoria, así que utilizamos el bloque del grupo **translators** __XY_16x16__ para que haga la traducción por nosotros",
            "readonly": true
          },
          "position": {
            "x": 1656,
        ...
        {
          "id": "7e9a856d-93e9-4983-8178-ef100c386a64",
          "type": "basic.info",
          "data": {
            "info": "Inicializamos la pantalla en blanco",
            "readonly": true
          },
          "position": {
            "x": 1920,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "af8428af-fe52-4de5-bc0e-fa4cd18f941a",
        ...
        },
        {
          ...
          "target": {
            "block": "d5f0e3fd-95de-49ae-bb8d-8eb81bbf5ca5",
        ...
        },
        {
          ...
          "target": {
            "block": "76a90ff9-681f-4378-b0b9-8d8b165e5332",
