  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "cade0048-9427-4061-8061-9e05ed5361ee",
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 1: Conexión LCD Hitachi HD44780U 2x16 en modo 8 bits\n\nEsta pantalla LCD es muy común en los kits de Arduino, a nivel visual los hay de diferentes formatos y colores, pero mientras tengan el chip HD44780U de Hitachi\npodrás conectarla y usar los módulos de esta colección.\n\nLa pantalla LCD nos permite visualizar 2 filas y 16 columnas.\n\nEl modo 8 bits indica que utilizaremos 8 pines de la FPGA para mandarle datos y comandos a la pantalla LCD.\n\nEste es el modo más eficiente ya que cada carácter o comando se escribe de una sóla vez, como veremos en el modo de 4 bits, podemos utilizar\nsólo 4 pines de la FPGA para el bus de datos de la LCD pero necesitaremos el doble de tiempo para ejecutar cada comando o escribir cada carácter.\n\nEn la gran mayoría de aplicaciones el modo de 4bits será más que suficiente y tendremos libres 4 pines de la FPGA.\n\nAdemás de los pines para el bus de datos, necesitaremos otros 3 pines de la FPGA para gestionar las señales de control que serán las encargadas de decirle a la LCD qué tiene que hacer.\n",
            "readonly": true
          },
          "position": {
            "x": -1112,
        ...
        {
          "id": "06abfdc1-3c5d-4036-9b60-5215e3a596ed",
          "type": "basic.info",
          "data": {
            "info": "En el siguiente esquema se muestra la interconexión entre nuestra **Alhambra-II y la pantalla LCD**:                          \n",
            "readonly": true
          },
          "position": {
            "x": -1096,
        ...
        {
          "id": "53352bf4-aaf8-43e4-98e6-07f6cee4490e",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "5f5aba4f-6ffd-43cd-92c0-060d82824a80",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "b8baa295-c964-44fb-bf54-45787395e2c9",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "6fdfe100-383f-4367-b853-9103a70147b9",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "fd3ff8fe-351c-4da0-86d7-5f7854dc18eb",
          "type": "basic.info",
          "data": {
            "info": "## Conexión",
            "readonly": true
        ...
        {
          "id": "5a135763-a8d5-43c7-96d4-a526847ac26c",
          "type": "basic.info",
          "data": {
            "info": "## Resultado",
            "readonly": true
        ...
        {
          "id": "6bdceaa3-8782-476a-a1e7-7bd7d8175a81",
          "type": "basic.info",
          "data": {
            "info": "![](https://github.com/charliva/icecrystal/raw/master/assets/examples/00_lcd_basic_8bits.svg?sanitize=true)",
            "readonly": true
          },
          "position": {
            "x": -1112,
        ...
        {
          "id": "90588d8e-8822-4f20-a025-440ba9c7ed33",
          "type": "basic.info",
          "data": {
            "info": "**Material**:\n* 1x Resistencia 220 Ohms\n* 1x Pantalla LCD con chip HD44780U\n* 1x Breadboard\n* 1x Potenciómetro de 10K Ohms\n* 1x Alhambra-II\n* Cables rígidos o cables dupont para realizar las interconexiones",
            "readonly": true
          },
          "position": {
            "x": -1112,
        ...
        {
          "id": "7c3214e7-f151-415d-a94c-73bd3cdca04a",
          "type": "basic.info",
          "data": {
            "info": "![alt text](https://github.com/charliva/icecrystal/raw/master/assets/examples/idea.svg?sanitize=true \"FPGA Tip\")",
            "readonly": true
          },
          "position": {
            "x": -1112,
        ...
        {
          "id": "64bd9db6-9725-4239-9456-837b426b89d6",
          "type": "basic.info",
          "data": {
            "info": "_Fíjate lo limpio que queda el esquemático._\n_Si buscas por internet esquemas por ejemplo entre Arduino o Raspberry Pi y esta misma LCD, encontrarás auténticos_\n_líos de cables entrecruzados._\n\n_Esto es una característica muy importante, en la FPGA podemos definir qué pines queremos usar y definirlos_\n_como entradas, salidas  o entradas/salidas y esto nos permite reorganizar las conexiones como mejor nos venga._",
            "readonly": true
          },
          "position": {
            "x": -1048,
